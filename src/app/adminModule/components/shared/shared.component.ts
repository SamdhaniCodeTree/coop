...
export class SharedComponent implements OnInit {
  ...
  admin_madhudiv=false;
  ngOnInit(): void {

    if(this.session.userName=="adminspdyr" || this.session.userName=="add_rgr" || this.session.userName=="comm_coops"){
      this.Departmentadmin=true;
      this.admin_madhudiv=false;
    }
    if(this.session.userName=="admin_madhu" || this.session.userName=="admin_khadar"){
      this.admin_madhudiv=true;
      this.Departmentadmin=true;
    }
    ...
    this.admin=false;
    if(this.userName=='admin_madhu' || this.userName=='testvenkat')      
        this.admin=true;
  ...
  async adminApcob_Redirection(): Promise<void> {
