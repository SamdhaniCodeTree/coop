...
@Component({
  selector: 'app-completed-pacs-for-installation-rpt',
  templateUrl: './completed-pacs-for-installation-rpt.component.html',
  styleUrls: ['./completed-pacs-for-installation-rpt.component.css']
})
export class CompletedPacsForInstallationRptComponent implements OnInit {
...
division=false;
  ...
  ngOnInit(): void {    debugger;
    ...
    if(this.type == '13' || this.type == '16') { this.userName = "INSTALLATION COMPLETED PACS REPORT";}
  }
