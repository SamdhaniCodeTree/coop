...
@Component({
  selector: 'app-completed-pacs-for-delivery-rpt',
  templateUrl: './completed-pacs-for-delivery-rpt.component.html',
  styleUrls: ['./completed-pacs-for-delivery-rpt.component.css']
})
export class CompletedPacsForDeliveryRptComponent implements OnInit {
...
division=false;
  ...
  ngOnInit(): void {    debugger;
    ...
    if(this.type == '12' || this.type == '15'){
      this.userName = " DELIVERY COMPLETED PACS REPORT"
    }
  }
