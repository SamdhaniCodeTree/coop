...
@Component({
  selector: 'app-calibration-state-level-abstract-details',
  templateUrl: './calibration-state-level-abstract-details.component.html',
  styleUrls: ['./calibration-state-level-abstract-details.component.css']
})
export class CalibrationStateLevelAbstractDetailsComponent implements OnInit, OnDestroy, AfterViewInit { 
...
    };
      ...
      const req = {
        ...
        input_09: this.reportFromDate,
        input_10: this.reportToDate,
  ...
  reporttype:any;
  btnCalibdoneDetails(obj: any): void {

    if(this.typeid == "1"){
      this.reporttype = "32"
    }else{ this.reporttype = "33" }
    debugger;
    const requestData = {
      typeid:this.typeid,
      ...
      dccbName:obj.NAME_OF_THE_DCCB,
      dccbCode:obj.DCCB_CODE,
