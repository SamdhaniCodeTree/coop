...
@Component({
  selector: 'app-completed-pacs-for-delivery-details',
  templateUrl: './completed-pacs-for-delivery-details.component.html',
  styleUrls: ['./completed-pacs-for-delivery-details.component.css']
})
export class CompletedPacsForDeliveryDetailsComponent implements OnInit {
