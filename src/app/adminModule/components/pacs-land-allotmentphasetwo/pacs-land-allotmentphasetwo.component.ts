...
@Component({
  selector: 'app-pacs-land-allotmentphasetwo',
  templateUrl: './pacs-land-allotmentphasetwo.component.html',
  styleUrls: ['./pacs-land-allotmentphasetwo.component.css']
})
export class PacsLandAllotmentphasetwoComponent implements OnInit {
